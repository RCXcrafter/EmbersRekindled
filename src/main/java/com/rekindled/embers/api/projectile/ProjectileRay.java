...
public class ProjectileRay implements IProjectilePreset {
	...
	public void shoot(Level world) {
		...
		if (!world.isClientSide) {
			PacketHandler.INSTANCE.send(PacketDistributor.TRACKING_ENTITY_AND_SELF.with(() -> shooter), new MessageEmberRayFX(startX,startY,startZ,dX,dY,dZ,impactDist,Misc.intColor(color),this.colorId));
		}
	}
}
