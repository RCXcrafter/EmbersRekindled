...
public class EmbersBiomeModifiers {
	...
	public static void generate(BootstapContext<BiomeModifier> bootstrap) {
		...
		bootstrap.register(GOLEM_SPAWN, new AddSpawnsBiomeModifier(overworldBiomes, List.of(new MobSpawnSettings.SpawnerData(RegistryManager.ANCIENT_GOLEM.get(), 10, 1, 1))));
	}
}
