...
public class EmbersBlockStates extends BlockStateProvider {
	...
	protected void registerStatesAndModels() {
		...
		.part().modelFile(fluidPipeEndModel).rotationX(180).addModel()
		...
		.part().modelFile(fluidPipeEndModel).rotationX(90).rotationY(180).addModel()
		...
		.part().modelFile(fluidPipeEndModel).rotationX(90).rotationY(270).addModel()
